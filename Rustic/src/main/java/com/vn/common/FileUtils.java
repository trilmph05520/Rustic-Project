...
public class FileUtils {
	public static Result executeStorage(String uploadingDirectory, String fileName, String base64Encode,
		...
		try {
			...
			if (!isUniqueNameFile) {
				...
				String fileNameCustom = FilenameUtils.removeExtension(fileName) + '_' + nowFormat + '.'
	...
	public static Result executeStorage(String uploadingDirectory, DescriptionBase64File descriptionBase64File,
			boolean isAllowOverRide, boolean isUniqueNameFile, String webContextPath) {
		String base64Encode = descriptionBase64File.getContent();
		String fileName = descriptionBase64File.getFileName();
		return executeStorage(uploadingDirectory, fileName, base64Encode, isAllowOverRide, isUniqueNameFile,
				webContextPath);
	}

	public static Result executeStorage(String uploadingDirectory, DescriptionBase64File[] descriptionBase64Files,
			boolean isAllowOverRide, boolean isUniqueNameFile, String webContextPath) {
		boolean isSuccessAll = true;
		String pathImages = "[";
		for (DescriptionBase64File descriptionBase64File : descriptionBase64Files) {
			Result result = executeStorage(uploadingDirectory, descriptionBase64File, isAllowOverRide, isUniqueNameFile,
					webContextPath);
...
//        pathImages = pathImages.substring(0, pathImages.length() - 1);
	...
	public static Result storageFile(String uploadingDirectory, DescriptionBase64File descriptionBase64File,
			boolean isAllowOverRide, boolean isUniqueNameFile) {
		return executeStorage(uploadingDirectory, descriptionBase64File, isAllowOverRide, isUniqueNameFile, null);
	}

	public static Result storageFile(String uploadingDirectory, DescriptionBase64File descriptionBase64File,
			boolean isAllowOverRide, boolean isUniqueNameFile, String webContextPath) {
		return executeStorage(uploadingDirectory, descriptionBase64File, isAllowOverRide, isUniqueNameFile,
				webContextPath);
	}

	public static Result storageFile(String uploadingDirectory, DescriptionBase64File[] descriptionBase64Files,
			boolean isAllowOverRide, boolean isUniqueNameFile) {
		return executeStorage(uploadingDirectory, descriptionBase64Files, isAllowOverRide, isUniqueNameFile, null);

	}

	public static Result storageFile(String uploadingDirectory, DescriptionBase64File[] descriptionBase64Files,
			boolean isAllowOverRide, boolean isUniqueNameFile, String webContextPath) {
		return executeStorage(uploadingDirectory, descriptionBase64Files, isAllowOverRide, isUniqueNameFile,
				webContextPath);
