...
public class Infomation implements Serializable {
	...
	public Infomation(String province, String town, String address, String phone, Date birthday, String bank,
			String company, String atmNumber, String infoPlus, String isDelete, AuthUser authUser) {
