...
public class ReportController {
	...
	public String listReport(Model model, HttpSession session, Pageable pageable, HttpServletRequest request,
			HttpServletResponse response, @RequestParam(value = "from_date", defaultValue = "") String fromDate,
				...
				new Thread(() -> {
					try {
						...
						final String htmlContent = ThymeleafUtil.getHtmlContentInClassPath(
								"html/MailThankiuReviewAndReport.html", (HashMap<String, Object>) map);
						mailSender.sendSimpleMailWarningTLS("Rustic<trilmph05520@fpt.edu.vn>", report1.getEmail(),
